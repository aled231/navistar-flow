...
class FlowRateAppClient:
    ...
    def measure_flow_rate(self):
        if self.is_measuring:
            ...
            self.flowlabel=Label(text="Flowrate ="f"{flow_rate_meter1:01}")
            ...
            self.flow_rate_label.configure(
                text=f"Flow Rate Meter 1: {flow_rate_meter1:.2f} GPM, Flow Rate Meter 2: {flow_rate_meter2:.2f} GPM")
    ...
    def Manualentry(self): #This is the function for starting the test and asking at what flow rates to perform the test
        ...
        self.cont=ttk.Button(text = 'Enter Flowrate', command=self.cont_manual)
    ...
    def Minute_entry(self): #This is the function for starting the test and asking at what flow rates to perform the test
        ...
        self.contmin = ttk.Button(text = 'Enter Minutes', command=self.cont_manual_time)
    ...
    def Seconds_entry(self): #This is the function for starting the test and asking at what flow rates to perform the test
        ...
        self.contsec = ttk.Button(text = 'Enter Seconds', command=self.cont_sec_time)
    ...
    def ask_quest(self):
        ...
        self.yes = ttk.Button(text = 'Enter another value', command=self.Manualentry)
        self.yes.grid(row=1, column=0, padx=10, pady=10)
        self.no = ttk.Button(text = 'Start test now', command = self.ManualUI)
